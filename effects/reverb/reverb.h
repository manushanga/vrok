...
public:
    ...
    void setDelay(int idx, float delay){ if (idx>=0 && idx<MAX_REVERBS) { reverb_delay[idx]=delay*VPBUFFER_FRAMES*bin->chans; } }
    float getDelay(int idx) { return (reverb_delay[idx]*1.0f)/VPBUFFER_FRAMES*bin->chans; }
